/**
 * "Building Agentic AI Systems — Pre-Assessment" for the 2026-07-19 cohort
 * (course runs 19–23 July). Trimmed version: name + email + graded questions only.
 *
 * Differs from create_pre_assessment_form.gs (the 2026-07-05 version) in that the
 * self-rating scales, prior-experience questions, and open-ended paragraphs are
 * removed — nothing but the identity fields and the 12 graded concept questions.
 *
 ...
 * named "Building Agentic AI Systems — Pre-Assessment 2026-07-19 (Responses)".
 */
function createPreAssessmentForm() {
  ...
  const ss = SpreadsheetApp.create('Building Agentic AI Systems — Pre-Assessment 2026-07-19 (Responses)');
